...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="home.php" class="logo">Poli<span>Farm</span></a>
      ...
      <div class="profile">
         ...
         <a href="components/user_logout.php" class="delete-btn" onclick="return confirm('Seguro de cerrar sesion?');">Desconectar</a> 
         <?php
            }else{
         ?>
         <p>Inicia sesion primero</p>
         <div class="flex-btn">
