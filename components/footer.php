<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         <h3>Contactanos</h3>
         <a href="tel:31681575"><i class="fas fa-phone"></i> +57 3045621042</a>
         <a href="mailto:juansebastian031@gmail.com"><i class="fas fa-envelope"></i> polifarm@gmail.com</a>
         <a href=""><i class="fas fa-map-marker-alt"></i> Bogota, Colombia</a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Poli Farm</span> | todos los derechos reservados</div>
